...
Edition.find_or_create_by(name: "third")

# ##################################################
# Badges
# ##################################################

Badge.find_or_create_by(name: 1, image: "badges/midterm.png", thumbnail: "badges/thumbnails/midterm.png", description: "Badge awarded when mentee completed midterm survey")
Badge.find_or_create_by(name: 2, image: "badges/finalterm.png", thumbnail: "badges/thumbnails/finalterm.png", description: "Badge awarded when mentee completed final survey")
Badge.find_or_create_by(name: 3, image: "badges/organized.png", thumbnail: "badges/thumbnails/organized.png", description: "Badge awarded when mentee enters roadmap")
Badge.find_or_create_by(name: 4, image: "badges/ambitious.png", thumbnail: "badges/thumbnails/ambitious.png", description: "Badge awarded when mentee completes all tasks for 3 weeks in a row")
