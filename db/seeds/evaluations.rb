...
MenteeApplication.find_by(email: "mentee@litg.com").update_attributes(state: 4, evaluator_id: 1)
MentorApplication.find_by(email: "mentor@litg.com").update_attributes(state: 4, evaluator_id: 1)
