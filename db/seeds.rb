...
Badge.create(name: 8, image: "badges/ambitious.png", thumbnail: "badges/thumbnails/ambitious.png", description: "Badge awarded when mentee completes all tasks 3 weeks in a row")
