@MenteeApplicationStep3 = React.createClass
  ...
  render: ->
    React.DOM.div
      ...
      React.createElement(ApplicationRadioGroup, go: @go, key: 'previousProgrammingExperience', field: 'previous_programming_experience', options: @yesNoOptions(), placeholder: "Do you have previous experience in any other programming language?", application: @props.application, setApplicationField: @props.setApplicationField)
      ...
      if @props.application.programming_language == 'ruby' && @props.application.operating_system == 'windows'
        @systemWarning()
      React.createElement(ApplicationTextArea, key: 'projectProposal', field: 'project_proposal', label: "Which project would you like to develop during the learning period?", application: @props.application, setApplicationField: @props.setApplicationField)
