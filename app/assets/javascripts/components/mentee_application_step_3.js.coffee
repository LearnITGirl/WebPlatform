  ...
  render: ->
    React.DOM.div
      ...
      if @props.application.previous_programming_experience == 'true'
        React.createElement(ApplicationLanguageExperience, key: 'programming_experience', field: 'programming_experience', groupId: 'prog_exp', options: @props.programming_languages, placeholder: "Please select the language(s), your level of expertise (beginner, intermediate, professional) and tell us about the projects you have worked on.", application: @props.application, setApplicationField: @props.setApplicationField, level_field: 'programming_experience_level', detail_field: 'programming_experience_detail')
      ...
      React.createElement(ApplicationRadioGroup, key: 'previousParticipation', field: 'previous_participation', groupId: 'prev_part', options: @yesNoOptions(), placeholder: "Who did you participate as in the previous edition(s)?", application: @props.application, setApplicationField: @props.setApplicationField)
