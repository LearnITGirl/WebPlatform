  ...
  render: ->
    React.DOM.div
      ...
      if @props.application_type == 'mentee'
        React.createElement(ApplicationAgreeCheckbox, key: 'sendToMentorConfirmed', field: 'send_to_mentor_confirmed', name: 'I agree', checked: false, placeholder: "In case your application is successful we would like to forward the information collected in this form to your future mentor. He or she can use it to prepare for your first meeting/call. Please confirm that you agree to this.", application: @props.application, setApplicationField: @props.setApplicationField)
