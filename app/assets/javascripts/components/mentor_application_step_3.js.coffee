@MentorApplicationStep3 = React.createClass
  ...
  render: ->
    React.DOM.div
      ...
      React.createElement(ApplicationLanguageExperience, key: 'programmingLanguages', field: 'programming_languages', groupId: 'prog_exp', options: @props.programming_languages, placeholder: "What programming language(s) do you feel comfortable to teach during the mentorship program?", application: @props.application, setApplicationField: @props.setApplicationField, level_field: 'programming_experience_level', detail_field: 'programming_languages_info')